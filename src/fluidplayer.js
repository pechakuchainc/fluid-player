...
const fluidPlayerClass = function () {
    ...
    self.init = (playerTarget, options) => {
        ...
        const videoWrapper = document.getElementById(
            "fluid_video_wrapper_" + playerNode.id
        );
    ...
    self.generateCustomControlTags = (options) => {
        ...
        if (options.controlForwardBackward) {
            ...
            controls.skipBack.id =
                self.videoPlayerId + "_fluid_control_skip_back";
            ...
            controls.skipForward.id =
                self.videoPlayerId + "_fluid_control_skip_forward";
        ...
        controls.progressContainer.id =
            self.videoPlayerId + "_fluid_controls_progress_container";
        ...
        controls.progressCurrent.id =
            self.videoPlayerId + "_vast_control_currentprogress";
        ...
        controls.progress_current_marker.id =
            self.videoPlayerId + "_vast_control_currentpos";
        ...
        controls.fullscreen.id =
            self.videoPlayerId + "_fluid_control_fullscreen";
        ...
        controls.videoSource.id =
            self.videoPlayerId + "_fluid_control_video_source";
        ...
        controls.playbackRate.id =
            self.videoPlayerId + "_fluid_control_playback_rate";
        ...
        controls.volumeContainer.id =
            self.videoPlayerId + "_fluid_control_volume_container";
        ...
        controls.volumeCurrent.id =
            self.videoPlayerId + "_fluid_control_currentvolume";
        ...
        controls.volumeCurrentPos.id =
            self.videoPlayerId + "_fluid_control_volume_currentpos";
    ...
    self.controlPlayPauseToggle = () => {
        ...
        const menuOptionPlay = document.getElementById(
            self.videoPlayerId + "context_option_play"
        );
        ...
        const initialPlay = document.getElementById(
    ...
    self.contolVolumebarUpdate = () => {
        const currentVolumeTag = document.getElementById(
            self.videoPlayerId + "_fluid_control_currentvolume"
        );
        const volumeposTag = document.getElementById(
            self.videoPlayerId + "_fluid_control_volume_currentpos"
        );
        const volumebarTotalWidth = document.getElementById(
            self.videoPlayerId + "_fluid_control_volume"
        ).clientWidth;
        ...
        const menuOptionMute = document.getElementById(
            self.videoPlayerId + "context_option_mute"
        );
    ...
    self.checkFullscreenSupport = (videoPlayerWrapperId) => {
        const videoPlayerWrapper =
            document.getElementById(videoPlayerWrapperId);
    ...
    self.fullscreenToggle = () => {
        ...
        const fullscreenTag = document.getElementById(
            "fluid_video_wrapper_" + self.videoPlayerId
        );
        ...
        const menuOptionFullscreen = document.getElementById(
            self.videoPlayerId + "context_option_fullscreen"
        );
    ...
    self.getEventOffsetY = (evt, el) => {
        ...
        const videoWrapper = self.findClosestParent(
            el,
            'div[id^="fluid_video_wrapper_"]'
        );

        if (videoWrapper) {
            const videoPlayerId = videoWrapper.id.replace(
                "fluid_video_wrapper_",
                ""
            );
    ...
    self.getNewCurrentTimeValueByKeyCode = (keyCode, currentTime, duration) => {
        ...
        switch (keyCode) {
            ...
            case 39: //right arrow
                newCurrentTime += 5;
                newCurrentTime =
                    newCurrentTime > duration - 5 ? duration : newCurrentTime;
                break;
            case 35: //End
    ...
    self.handleWindowClick = (e) => {
        ...
        const inScopeClick =
            ...
            e.target.id === "skipHref_" + self.videoPlayerId;
    ...
    self.initialPlay = () => {
        ...
        if (!self.displayOptions.layoutControls.playButtonShowing) {
            ...
            const initialControlsDisplay = document.getElementById(
                self.videoPlayerId + "_fluid_controls_container"
            );
            initialControlsDisplay.classList.remove("initial_controls_show");
            // The logo shows before playing but may need to be removed
            const fpPlayer = document.getElementById(
                self.videoPlayerId + "_logo"
            );
            if (fpPlayer) {
    ...
    self.playPauseToggle = () => {
        ...
        if (isFirstStart) {
            ...
            const pseudoPoster = document.getElementById(
                self.videoPlayerId + "_fluid_pseudo_poster"
            );
            if (pseudoPoster) {
        ...
        const blockOnPause = document.getElementById(
            self.videoPlayerId + "_fluid_html_on_pause"
        );
    ...
    self.setCustomControls = () => {
        ...
        document
            ...
            .addEventListener(
                eventOn,
                (event) => self.onVolumeBarMouseDown(),
                false
            );
        ...
        if (
            ...
            document.getElementById(
                self.videoPlayerId + "_fluid_control_theatre"
        ...
        document
            ...
            .addEventListener(
                ...
                (event) => {
                    ...
                    const hoverTimeItem = document.getElementById(
                        self.videoPlayerId + "_fluid_timeline_preview"
                    );
    ...
    self.createVideoSourceSwitch = () => {
        ...
        const sourceChangeButton = document.getElementById(
            self.videoPlayerId + "_fluid_control_video_source"
        );
        ...
        sourceChangeList.id =
            self.videoPlayerId + "_fluid_control_video_source_list";
        ...
        for (const source of self.videoSources) {
            ...
            sourceChangeDiv.id =
                "source_" + self.videoPlayerId + "_" + source.title;
            ...
            sourceChangeDiv.addEventListener("click", function (event) {
                ...
                const sourceIcons =
                    document.getElementsByClassName("source_button_icon");
    ...
    self.openCloseVideoSourceSwitch = () => {
        const sourceChangeList = document.getElementById(
            self.videoPlayerId + "_fluid_control_video_source_list"
        );
    ...
    self.initPlayButton = () => {
        ...
        console.log("FLUID initPlayButton");
        const containerDiv = document.createElement("div");
    ...
    self.createPlaybackList = () => {
        ...
        const sourceChangeList = document.createElement("div");
        sourceChangeList.id =
            self.videoPlayerId + "_fluid_control_video_playback_rate";
    ...
    self.createDownload = () => {
        const downloadOption = document.getElementById(
            self.videoPlayerId + "_fluid_control_download"
        );
    ...
    self.theatreToggle = () => {
        ...
        if (self.displayOptions.layoutControls.theatreAdvanced) {
            const elementForTheatre = document.getElementById(
        ...
        if (
            ...
            const sourceOption = document.getElementById(
                "source_" +
                    self.videoPlayerId +
                    "_" +
                    self.fluidStorage.fluidQuality
            );
            const sourceChangeButton = document.getElementById(
                self.videoPlayerId + "_fluid_control_video_source"
            );
    ...
    self.setHtmlOnPauseBlock = (passedHtml) => {
        ...
        const htmlBlock = document.getElementById(
            self.videoPlayerId + "_fluid_html_on_pause"
        );
    ...
    self.toggleControlBar = (show) => {
        const controlBar = document.getElementById(
            self.videoPlayerId + "fluid_controls_container"
        );
