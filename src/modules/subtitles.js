...
export default function (playerInstance, options) {
    ...
    playerInstance.createSubtitlesSwitch = () => {
        ...
        if (!playerInstance.displayOptions.layoutControls.subtitlesEnabled) {
            ...
            document.getElementById(
                playerInstance.videoPlayerId + "_fluid_control_subtitles"
            ).style.display = "none";
            return;
        }
        ...
        const subtitlesChangeButton = document.getElementById(
            playerInstance.videoPlayerId + "_fluid_control_subtitles"
        );
        ...
        subtitlesChangeList.id =
            playerInstance.videoPlayerId + "_fluid_control_subtitles_list";
        ...
        playerInstance.subtitlesTracks.forEach(function (subtitle) {
            ...
            subtitlesChangeDiv.addEventListener("click", function (event) {
                ...
                const subtitleIcons = document.getElementsByClassName(
    ...
    playerInstance.renderSubtitles = () => {
        ...
        let subtitlesContainer = document.getElementById(
            playerInstance.videoPlayerId + "_fluid_subtitles_container"
        );
    ...
    playerInstance.openCloseSubtitlesSwitch = () => {
        const subtitleChangeList = document.getElementById(
            playerInstance.videoPlayerId + "_fluid_control_subtitles_list"
        );
